  ...
  return (
    <footer className="bg-oceanic-noir/90 border-t border-arctic-powder/5 px-4 py-16 text-left select-none relative z-10">
      ...
      <div className="max-w-6xl mx-auto border-t border-arctic-powder/5 mt-12 pt-8 flex items-center justify-between">
        ...
        <button
          onClick={scrollToTop}
          className="p-3 rounded-full bg-nocturnal-expedition border border-mystic-mint/10 hover:border-mystic-mint/30 text-mystic-mint hover:text-white transition-colors duration-150 focus:outline-none shadow-md shadow-nocturnal-expedition/10 cursor-pointer"
        >
